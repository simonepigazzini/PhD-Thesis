...
% Object level improvements translates into an increased sensitivity for the physics analysis, either in the form
% of reduced background, extend acceptance or through the use of the pure time information to reconstruct quatities
% otherwise inaccessible. A summary of the impact of timing is reported in Table~\ref{tab:timing_analysis_gain},
% the table also underlines the contribution from the various detectors involved in the time measurement.
